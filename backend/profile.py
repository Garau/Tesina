...
def profile(request, session, username):
	...
	if username == session['username']:
		return render_template('profile.html', session = True, username = username, profile_pic = profile_pic, name = name, surname = surname, email = email, review_num = review_num, fav_genre = fav_genre, fav_albums = fav_albums)
	else:
		if 'username' not in session:
			print("You are not logged")
			return render_template('profile.html', other = True, username = username, profile_pic = profile_pic, name = name, surname = surname, email = email, review_num = review_num, fav_genre = fav_genre, fav_albums = fav_albums)
		else:
			print("You are not " + username)
			return render_template('profile.html', session = True, other = True, username = username, profile_pic = profile_pic, name = name, surname = surname, email = email, review_num = review_num, fav_genre = fav_genre, fav_albums = fav_albums)
